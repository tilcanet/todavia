...
template_path = os.path.join(BASE_DIR, "core", "templates", "aliado_dashboard.html")

print(f"Update target: {template_path}")

try:
    with open(template_path, "w", encoding="utf-8") as f:
        f.write(content)
    print("SUCCESS: File rewritten successfully on server.")
